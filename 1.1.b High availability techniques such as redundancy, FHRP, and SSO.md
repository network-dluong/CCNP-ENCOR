...
* Industry standard and slightly different to HSRP:
  * Master router – preferred active router controlling VIP gateway
  * Backup router – all other VRRP routers
  * Enable preemption by default
  * MAC address of VIP gateway uses structure 0000.5e00.01xx (xx is group ID in hex)
  * Use multicast address 224.0.0.18
  * VRRPv2 – supports IPv4; VRRPv3 – supports IPv4 and IPv6

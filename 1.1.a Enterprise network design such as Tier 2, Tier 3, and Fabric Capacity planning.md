...
* Additional scalability and better performance for east/west traffic flows by adding additional switches  
* All Leaf switches are connected to all Spine switches (mesh)  
